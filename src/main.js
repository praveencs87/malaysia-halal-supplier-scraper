...
try {
    ...
    const crawler = new PlaywrightCrawler({
        ...
        async requestHandler({ page, request, log, enqueueLinks }) {
            ...
            for (const item of items) {
                ...
                const supplierName = (await nameElement.innerText()).trim();
                ...
                const fullListingUrl = listingUrl && !listingUrl.startsWith('http') ? new URL(listingUrl, 'https://www.yellowpages.my').toString() : listingUrl;
                ...
                if (supplierName && supplierName.length > 1) {
                    ...
                    extractedCount++;
                    log.info(`✅ Extracted: ${supplierName} (${extractedCount}/${maxLeads})`);
                }
            }
            ...
            if (extractedCount < maxLeads) {
                ...
                if (hasNextPage) {
                    ...
                    if (nextUrl) {
                        const absoluteUrl = new URL(nextUrl, 'https://www.yellowpages.my').toString();
    ...
    log.info(`🎉 Done! Extracted ${extractedCount} Malaysia Halal Supplier leads.`);
